        ...
        <SafeAreaView style={estilos.container}>
            ...
            >
                ...
                <View style={estilos.card}>
                    <Image style={estilos.cardImage} source={''} />
                    <View style={estilos.cardInfo}>
                        <View style={estilos.cardHeader}>
                            <Text style={estilos.cardName}>Carolina Vasconcelos</Text>
                            <TouchableOpacity>
                                <Ionicons name="heart" size={20} color={'#FF3B30'} />
                            </TouchableOpacity>
                        </View>
                        <Text style={estilos.cardSpecialty}>Nutricionista</Text>
                        <View style={estilos.ratingContainer}>
                            ...
                            <Text style={estilos.ratingText}>5.0 | 77 avaliações</Text>
                        </View>
                    </View>
                </View>
